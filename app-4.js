...
const TRAINING_COURSES = [
  ...
  // v2.46.145: курс «Занести договор» — для менеджера, принимающего продажи
  {
    id: 'contract_new', icon: 'ti-file-plus',
    title: 'Школа договора',
    summary: 'Завести договор так, чтобы от него правильно поехало всё: спецификация, производство, закупка и отгрузка.',
    pass: 10,
    chapters: [
      { icon: 'ti-target', title: 'Договор — центр всей CRM', blocks: [
        { p: 'Договор — центральная сущность Продаж. К нему привязываются <b>сборки производства</b>, <b>спецификация</b> (что поставляем), <b>задачи</b>, <b>заявки на закупку</b>, <b>коробки и отгрузка</b>, чат и монтаж. Плохо заведённый договор — это потерянные позиции и сорванные сроки, поэтому заносим внимательно.' },
        { p: 'Жизнь договора — цепочка статусов: <b>В производстве → Готов к отгрузке → Отгружен частично → Отгружен → Закрыт</b>. Статусы переключаются в карточке договора.' },
        { note: 'Создавать и редактировать договоры может <b>директор, зам или менеджер</b>. Редактирование уже созданного — под личным паролем.' },
      ] },
      { icon: 'ti-users', title: 'Сначала контрагент', blocks: [
        { p: 'Договор всегда привязан к контрагенту (клиенту). Перед занесением проверь, есть ли клиент в <b>Продажи → Контрагенты</b>.' },
        { ul: [
          'Нет в списке — создай прямо из формы договора кнопкой <b>«+»</b> рядом с полем, форму бросать не нужно',
          'Заполни: название, <b>ИНН</b>, контактное лицо, телефон, email, адрес',
          'В карточке контрагента потом видна вся история его договоров — удобно при повторном звонке',
        ] },
      ] },
      { icon: 'ti-forms', title: 'Форма договора: что заполняем', blocks: [
        { h: 'Обязательные поля' },
        { ul: [
          '<b>Номер договора</b> — как в учёте',
          '<b>Дата подписания</b>',
          '<b>Контрагент</b>',
        ] },
        { h: 'Остальное — тоже важно' },
        { ul: [
          '<b>Тип</b>: «Только поставка», «Поставка + монтаж» или «Только монтаж» — у монтажных типов в карточке появится блок «Монтаж»',
          '<b>Юрлицо</b>, от которого работаем',
          '<b>Сумма</b> и <b>дата оплаты</b>',
          '<b>Дата и адрес доставки</b>, срок в рабочих или календарных днях',
          '<b>Менеджер</b> (по умолчанию ты) и дополнительные менеджеры',
        ] },
        { note: 'Форма <b>автосохраняет черновик</b>: случайно закрыл — при следующем «Новый договор» всё восстановится. Кнопка «Очистить черновик» начинает с нуля.' },
      ] },
      { icon: 'ti-list-details', title: 'Спецификация — что входит в договор', blocks: [
        { p: 'Сразу после создания наполни блок <b>«Спецификация»</b> в карточке договора: всё, что поставляется клиенту — наши сборки, покупное, материалы. По ней контролируются производство, отгрузка и документы.' },
        { ul: [
          '«+ Добавить позицию» → начни вводить название, появятся подсказки; кнопка <b>▦</b> открывает обозреватель',
          'Вкладка <b>«Производство»</b> — модели наших изделий: позиция запомнит модель и свяжется со сборками',
          'Вкладка <b>«Продажи»</b> — товары и услуги из продажной номенклатуры (модели нет)',
          'Можно вписать свободный текст — для разовых нестандартных позиций',
          'Готовую спецификацию выгружай в <b>Word/PDF</b> кнопками в шапке блока',
        ] },
      ] },
      { icon: 'ti-progress-check', title: 'Статусы, замок и «На хранении»', blocks: [
        { ul: [
          'Статус переключается плитками в карточке; поставить <b>«Отгружен»</b> не даст <b>замок</b>, пока реально отгружено не всё — клик покажет, чего не хватает',
          '<b>«На хранении»</b> — не статус, а отметка поверх «Готов к отгрузке»: всё сделано, но заказчик просит подождать. Резервы и планы не поедут',
          'Все правки договора пишутся в <b>историю</b> (аудит) — видно, кто и что менял',
        ] },
      ] },
      { icon: 'ti-alert-triangle', title: 'Особые случаи', blocks: [
        { ul: [
          '<b>КП согласовали</b> — не заноси договор руками: в карточке КП есть кнопка «создать договор на основе КП», контрагент и сумма перенесутся',
          '<b>Ошибся в договоре</b> — «Редактировать» в карточке, подтверждение личным паролем',
          '<b>QR договора</b> — печатается из карточки: наклей на папку с бумагами, скан открывает договор в CRM',
          '<b>Чат договора</b> — обсуждение прямо в карточке, вся переписка по объекту в одном месте',
        ] },
        { note: '<b>Золотое правило:</b> договор без спецификации — пустышка. Занёс шапку — сразу наполни спецификацию, иначе производство и снабжение о позициях не узнают.' },
      ] },
    ],
    checklist: [
      { t: 'Прочитал все главы курса', s: 'Понял цепочку статусов и зачем нужна спецификация' },
      { t: 'Нашёл и открыл карточку контрагента', s: 'Продажи → Контрагенты: история договоров клиента' },
      { t: 'Завёл учебный договор под присмотром', s: 'Номер, дата, контрагент, тип, юрлицо, сроки' },
      { t: 'Наполнил спецификацию', s: 'Хотя бы одна позиция из «Производства» и одна покупная' },
      { t: 'Прошёл статусы и посмотрел замок «Отгружен»', s: 'И отметку «На хранении» на готовом договоре' },
      { t: 'Сдал тест на 10+ из 12', s: 'После этого заносишь договоры самостоятельно' },
    ],
    quiz: [
      { q: 'Какие поля обязательны при создании договора?',
        o: ['Номер, дата подписания и контрагент',
            'Только номер — остальное можно потом',
            'Номер, сумма и дата доставки'],
        a: 0, why: 'Без номера, даты подписания и контрагента форма не сохранится. Остальное — желательно, но не блокирует.' },
      { q: 'Клиента нет в списке контрагентов. Что делаешь?',
        o: ['Сохраняю договор без контрагента, клиента заведу потом',
            'Создаю контрагента кнопкой «+» прямо рядом с полем, не закрывая форму',
            'Пишу название клиента в комментарий'],
        a: 1, why: 'Контрагент обязателен, и создаётся из формы договора через «+» — форму бросать не нужно.' },
      { q: 'Что такое спецификация договора?',
        o: ['Технические характеристики наших изделий',
            'Всё, что поставляется клиенту по договору: сборки, покупное, материалы',
            'Список задач по договору'],
        a: 1, why: 'Спецификация = полный список поставки. По ней живут производство, отгрузка и документы.' },
      { q: 'Чем позиция из вкладки «Производство» отличается от позиции из «Продаж»?',
        o: ['Ничем, это одно и то же',
            'Позиция из «Производства» запоминает модель и свяжется со сборками; из «Продаж» — просто товар/услуга',
            'Позиции из «Продаж» нельзя удалять'],
        a: 1, why: 'Выбор из «Производства» тянет model_id — через него позиция связывается со сборками в цехе.' },
      { q: 'Заполнял форму договора и случайно закрыл её. Что с данными?',
        o: ['Всё пропало, заполняю заново',
            'Черновик автосохранился — при следующем «Новый договор» форма восстановится',
            'Форма отправилась недозаполненной'],
        a: 1, why: 'Форма автосохраняет черновик. Восстановится сама; «Очистить черновик» — если нужно с нуля.' },
      { q: 'Правильная цепочка статусов договора?',
        o: ['В производстве → Готов к отгрузке → Отгружен частично → Отгружен → Закрыт',
            'Новый → Оплачен → Отгружен → Архив',
            'Черновик → В работе → Готово'],
        a: 0, why: 'Пять шагов: производство → готов → частично → отгружен → закрыт. Переключаются в карточке.' },
      { q: 'Пытаешься поставить статус «Отгружен», а на нём замок. Почему?',
        o: ['Нет прав — статусы меняет только директор',
            'Реально отгружено не всё: клик по замку покажет, каких позиций не хватает',
            'Договор не оплачен'],
        a: 1, why: 'Замок — страховка от «забыли погрузить»: пока не отгружено всё, статус не поставить.' },
      { q: 'Всё готово, но заказчик просит подержать товар у нас. Что ставишь?',
        o: ['Статус «Закрыт» — работа-то сделана',
            'Отметку «На хранении» поверх «Готов к отгрузке» — резервы и планы не поедут',
            'Статус «Отгружен» — чтобы не мешался в списке'],
        a: 1, why: '«На хранении» — отметка, не статус: договор ждёт отгрузки, ничего не ломая.' },
      { q: 'Зачем у договора тип («Только поставка» / «Поставка + монтаж» / «Только монтаж»)?',
        o: ['Просто для статистики',
            'У монтажных типов в карточке появляется блок «Монтаж» с его статусами, файлами и чатом',
            'От типа зависит номер договора'],
        a: 1, why: 'Тип включает монтажную часть карточки — статусы монтажа, файлы объекта, чат с монтажником.' },
      { q: 'Нужно исправить сумму в уже созданном договоре. Как?',
        o: ['Никак — договор менять нельзя',
            '«Редактировать» в карточке и подтвердить личным паролем',
            'Удалить договор и завести заново'],
        a: 1, why: 'Правки существующего договора — под личным паролем, и все изменения видны в истории.' },
      { q: 'Клиент согласовал КП. Как правильно завести договор?',
        o: ['Кнопкой «создать договор на основе КП» — контрагент и сумма перенесутся сами',
            'Только руками, заново набив все данные',
            'КП автоматически становится договором'],
        a: 0, why: 'Из согласованного КП договор создаётся одной кнопкой — меньше ручного ввода, меньше ошибок.' },
      { q: 'Занёс шапку договора. Что делаешь сразу после?',
        o: ['Ничего — производство само разберётся',
            'Наполняю спецификацию: без неё производство и снабжение о позициях не узнают',
            'Ставлю статус «Готов к отгрузке»'],
        a: 1, why: 'Договор без спецификации — пустышка: позиции не попадут ни в цех, ни в закупку, ни в отгрузку.' },
    ],
  },

  // v2.46.145: курс «Отгрузка» — для кладовщика/сборщика
  {
    id: 'shipment', icon: 'ti-truck-delivery',
    title: 'Школа отгрузки',
    summary: 'Собрать и отгрузить заказ по QR так, чтобы ничего не забыть в цехе и склад списался сам.',
    pass: 10,
    chapters: [
      { icon: 'ti-target', title: 'Из чего состоит отгрузка', blocks: [
        { p: 'В карточке договора есть блок <b>«К отгрузке»</b> — что физически уезжает с производства:' },
        { ul: [
          '<b>Коробки</b> — в них упаковано покупное и мелочь (и мелкие сборки)',
          '<b>Узлы и сборки</b> — крупное едет отдельно, каждая единица со своей наклейкой',
          '<b>Покупное отдельной позицией</b> — крупные покупные вещи без коробки',
        ] },
        { p: 'У каждой единицы бейдж: <b>«готово к отгрузке» → «собрано» → «отгружено»</b>. Прогресс виден в договоре и на Главной («Ближайшие отгрузки», кнопка «Отгрузить по договору»).' },
      ] },
      { icon: 'ti-qrcode', title: 'QR-наклейки и коробки', blocks: [
        { ul: [
          'Коробка создаётся в карточке договора (блок «Коробки» → «Добавить») — сразу даёт <b>QR-код для печати на наклейку</b>',
          'На сборках наклейки печатаются в производстве — QR ведёт на изделие',
          'Наклейка испортилась или код чужой — кнопка <b>перепечатать QR</b> у единицы выдаст новый код',
        ] },
        { note: 'QR — основа всей отгрузки: и сборка к отгрузке, и сама отгрузка идут сканированием. Наклейки клей на видное место.' },
      ] },
      { icon: 'ti-packages', title: 'Сборка к отгрузке — шаг ДО', blocks: [
        { p: 'Чтобы у ворот не выяснилось, что половины нет, есть отдельный шаг <b>до</b> отгрузки:' },
        { ol: [
          'Менеджер в договоре жмёт <b>«Запросить сборку к отгрузке»</b> — сборщику приходит уведомление',
          'Сборщик жмёт <b>«Начать сборку»</b> и сканирует QR каждой единицы, снося её в зону отгрузки',
          'Отсканированное получает бейдж <b>«собрано»</b> — прогресс виден менеджеру',
        ] },
        { p: 'Ошибся отметкой — есть <b>откат сборки</b>: снимает «собрано», склад при этом не трогается.' },
      ] },
      { icon: 'ti-scan', title: 'Сама отгрузка — по коду', blocks: [
        { p: 'Машина пришла — в договоре жми <b>«Отгрузить по коду (рекомендуется)»</b> и сканируй QR каждой коробки и сборки при погрузке. Прогресс N/M растёт на глазах.' },
        { ul: [
          'Отгруженная сборка <b>списывается со склада сама</b> — в Журнале движений появится «− Расход: отгружена по договору»',
          'QR не читается — у единицы есть ручная кнопка <b>«Отгрузить»</b> без сканирования (и перепечатай наклейку)',
          'Можно сканировать и <b>главным сканером</b> (📷 в шапке): скан любой единицы договора сам предложит открыть его отгрузку',
        ] },
      ] },
      { icon: 'ti-progress-check', title: 'Частичная отгрузка и завершение', blocks: [
        { ul: [
          'Уехала не вся машина — нормально: статус <b>«Отгружен частично»</b>, прогресс сохранится, довезёшь следующим рейсом',
          'Статус <b>«Отгружен»</b> под замком, пока отгружено не всё — страховка от «забыли погрузить»',
          '<b>Закрыть</b> договор тоже нельзя, пока не отгружено всё',
          'Всё готово, но клиент просит подождать — отметка <b>«На хранении»</b>, отгрузка подождёт',
        ] },
      ] },
      { icon: 'ti-alert-triangle', title: 'Особые случаи', blocks: [
        { ul: [
          '<b>Отгрузили не то / не туда</b> — «Откатить отгрузку» в договоре (директор/менеджер): остатки вернутся на склад',
          '<b>Скан не отмечает позицию</b> — наклейка битая или чужая: отгрузи вручную кнопкой и перепечатай QR',
          '<b>«Всё уже отгружено — собирать нечего»</b> — сборка к отгрузке потеряла смысл, запрос можно снять',
          '<b>Не видишь кнопок отгрузки</b> — нет права «Продажи/Склад»: скажи директору',
        ] },
        { note: '<b>Золотое правило:</b> грузишь — сканируй. Каждая единица через QR, тогда склад честный, а договор сам покажет, что осталось.' },
      ] },
    ],
    checklist: [
      { t: 'Прочитал все главы курса', s: 'Понял разницу «собрано» и «отгружено» и зачем QR' },
      { t: 'Нашёл блок «К отгрузке» в договоре', s: 'Коробки, узлы, покупное — и их бейджи' },
      { t: 'Создал коробку и распечатал QR', s: 'Блок «Коробки» → «Добавить» → печать наклейки' },
      { t: 'Прошёл сборку к отгрузке по QR', s: 'Под присмотром: запрос → «Начать сборку» → сканы → «собрано»' },
      { t: 'Отгрузил договор по коду', s: 'Под присмотром: сканы при погрузке, прогресс N/M, статус' },
      { t: 'Сдал тест на 10+ из 12', s: 'После этого отгружаешь самостоятельно' },
    ],
    quiz: [
      { q: 'Из каких единиц состоит отгрузка договора?',
        o: ['Только из коробок',
            'Коробки, отдельные узлы/сборки и крупное покупное отдельной позицией',
            'Из позиций спецификации, физических единиц нет'],
        a: 1, why: 'Блок «К отгрузке»: коробки (покупное и мелочь), узлы/сборки отдельно, крупное покупное отдельно.' },
      { q: 'Зачем шаг «Сборка к отгрузке» перед самой отгрузкой?',
        o: ['Чтобы заранее скомплектовать заказ по QR и у ворот не выяснилось, что половины нет',
            'Это то же самое, что отгрузка',
            'Чтобы списать сборки со склада заранее'],
        a: 0, why: 'Менеджер запрашивает сборку → сборщик сканирует единицы → бейджи «собрано». Склад при этом не трогается.' },
      { q: 'Чем отметка «собрано» отличается от «отгружено»?',
        o: ['Ничем, это синонимы',
            '«Собрано» — единица скомплектована в зоне отгрузки, склад не тронут; «отгружено» — уехала, сборка списана со склада',
            '«Собрано» ставит директор, «отгружено» — сборщик'],
        a: 1, why: 'Сборка к отгрузке — подготовка (без движения склада), отгрузка — списание и уезд.' },
      { q: 'Как правильно отгружать при погрузке машины?',
        o: ['«Отгрузить по коду»: сканировать QR каждой коробки и сборки',
            'Отметить всё галочками в конце дня по памяти',
            'Просто сменить статус договора на «Отгружен»'],
        a: 0, why: 'Рекомендуемый путь — сканирование каждой единицы: прогресс честный, склад списывается сам.' },
      { q: 'Что происходит со складом, когда сборка отгружена?',
        o: ['Ничего, склад правится вручную',
            'Сборка списывается автоматически — в Журнале движений «− Расход: отгружена по договору»',
            'Сборка переходит в резерв'],
        a: 1, why: 'Отгрузка по QR сама делает расход со склада — руками ничего списывать не нужно.' },
      { q: 'QR на коробке не читается (замялся, залит). Твои действия?',
        o: ['Не отгружать коробку, пока не привезут новую наклейку',
            'Отгрузить единицу ручной кнопкой «Отгрузить» и перепечатать QR (новый код)',
            'Отсканировать QR соседней коробки — какая разница'],
        a: 1, why: 'Ручная отгрузка без скана есть у каждой единицы. Чужой QR сканировать нельзя — отметится не то.' },
      { q: 'Машина увезла только половину заказа. Что дальше?',
        o: ['Это ошибка, нужно откатить отгрузку',
            'Нормально: договор станет «Отгружен частично», прогресс сохранится, остальное довезёшь следующим рейсом',
            'Поставить «Отгружен», раз машина уехала'],
        a: 1, why: 'Частичная отгрузка — штатный случай: N/M сохраняется, статус «частично» до полной отгрузки.' },
      { q: 'Почему не получается поставить договору статус «Отгружен»?',
        o: ['Статусы меняет только бухгалтер',
            'На статусе замок: реально отгружено не всё — клик покажет, чего не хватает',
            'Сначала нужно закрыть договор'],
        a: 1, why: 'Замок — страховка от «забыли погрузить»: пока есть неотгруженные единицы, статус не встанет.' },
      { q: 'Отгрузили не тот заказ. Что делать?',
        o: ['«Откатить отгрузку» в карточке договора — остатки вернутся на склад, потом отгрузить правильно',
            'Ничего не сделать — отгрузка необратима',
            'Удалить договор'],
        a: 0, why: 'Откат отгрузки (директор/менеджер) возвращает остатки на склад и снимает отметки.' },
      { q: 'Всё собрано, но клиент просит подержать заказ у нас пару недель. Что ставим?',
        o: ['Статус «Закрыт»',
            'Отметку «На хранении» — договор остаётся «Готов к отгрузке» и ждёт',
            'Откатить сборку, потом собрать заново'],
        a: 1, why: '«На хранении» — отметка поверх «Готов к отгрузке»: ничего не ломается, заказ ждёт команды.' },
      { q: 'Где с утра увидеть, что сегодня пора отгружать?',
        o: ['Только спросить у директора',
            'Главная: блок «Ближайшие отгрузки» и кнопка «Отгрузить по договору (готово N)», плюс календарь',
            'В разделе «Снабжение»'],
        a: 1, why: 'Главная показывает ближайшие отгрузки по датам доставки и договоры, готовые к отгрузке.' },
      { q: 'Отсканировал главным сканером (📷 в шапке) QR сборки. Что предложит CRM?',
        o: ['Ничего — главный сканер только для приёмки УПД',
            'Откроет изделие и сам предложит открыть отгрузку его договора',
            'Сразу спишет сборку со склада'],
        a: 1, why: 'Главный сканер понимает наклейки отгрузки: предлагает открыть отгрузку договора этой единицы.' },
    ],
  },
];
