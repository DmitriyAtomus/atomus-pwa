...
const HELP_CHANGELOG = [
  {
    version: 'v2.45.494',
    date: '23.06.2026',
    title: 'Атом Электрика — нет лишних контакторов + реле по размерам',
    features: [
      'Если нагрузка уже закреплена за общим контактором (через «что коммутирует»), система больше не плодит ей отдельный авто-контактор — например, 3 обеззараживателя на одном контакторе дают один KM, а не четыре',
      'Реле промежуточное теперь показывается с реальным габаритом (27×80×66 мм, на колодке РЭК77/3), а не «по модулям»',
    ],
  },
  {
    version: 'v2.45.493',
