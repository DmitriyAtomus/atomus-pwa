  ...
  // ---------- Продажи ----------
  {
    ...
    body: [
      ...
      { ol: [
        ...
        'Выбери <b>тип</b>: «Поставка» или «Поставка + монтаж»',
...
const HELP_CHANGELOG = [
  {
    version: 'v2.45.193',
    date: '09.06.2026',
    title: 'Подгруппы (подразделы) можно создавать на месте',
    features: [
      'В форме модели (новой и редактирования) рядом с «Подгруппа» появилась кнопка <b>«+ Новая»</b> — создаёт подраздел в выбранном направлении прямо тут',
      'Теперь можно <b>перенести модель в новый подраздел</b> (напр. ЩУ-004) и создавать модели сразу в нужной подгруппе',
    ],
  },
  {
    version: 'v2.45.192',
