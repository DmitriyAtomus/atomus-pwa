...
const HELP_CHANGELOG = [
  {
    ...
    features: [
      'В мастере «Атом Электрика» проект теперь сохраняется внутри приложения по кнопке «⭱ Сохранить»',
      'Новая кнопка «📂 Мои проекты» — список сохранённых щитов, любой можно открыть заново или удалить',
      'Сохранение/импорт через файл (.json) остались как запасной вариант для переноса между устройствами',
    ],
  },
  {
    version: 'v2.45.339',
