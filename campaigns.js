...
var CAMPAIGN_TEMPLATES = {
  new: { label: 'Первое знакомство — новая камера', subject: 'Планируете новую камеру созревания или расширение?', body: 'Добрый день, {{contact}}!\n\nМеня зовут Дмитрий, «Атомус Групп». Занимаемся климатическим оборудованием для камер созревания сыра.\n\nЕсли у вас в планах новая камера или расширение производства, предлагаем подготовить предварительный подбор оборудования и бюджет под вашу задачу.\n\nДля начала достаточно ответить на это письмо: какой сыр планируете выдерживать и какие размеры у помещения. Если есть фото, план или ТЗ — можно приложить. Остальные данные уточним вместе.\n\nЕсть такая задача сейчас или планируется позже?' },
