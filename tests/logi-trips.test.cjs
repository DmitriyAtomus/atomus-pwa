...
// 2ГИС обязан быть в формате «Поделиться маршрутом» (/tab/car, %2C, %3B):
// с голыми запятыми мобильное приложение открывало ПУСТОЙ маршрут.
test('ссылки 2ГИС и Яндекс собираются в правильном порядке координат', () => {
  ...
  assert.equal(links.gis, 'https://2gis.ru/directions/tab/car/points/60.1%2C55.04%3B60.08%2C55.08');
